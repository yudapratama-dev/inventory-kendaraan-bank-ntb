...
<head>
    <title>Login | Transport Inventory Bank NTB</title>
    <meta charset="utf-8">
            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('assets/img/logo-bank-ntb.png')}}" alt="Bank NTB Logo"></div>
                            </div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <div class="logo text-center margin-bottom-30"><img src="{{asset('assets/img/logo-bank-ntb.png')}}" alt="Bank NTB Logo"></div>
                            <h1 class="heading text-center">Transport Inventory</h1>
                            <p class="text-center">PT. Bank NTB Syariah</p>
                        </div>
                    </div>
